...
public class TrayViewWithOneItem extends View {

    public static final String TAG = TrayViewWithOneItem.class.getSimpleName();
    ...
    public TrayViewWithOneItem(Context context, int trayItemsNameArray, int trayItemIconArray) {
        super(context);
    ...
    public TrayViewWithOneItem(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
        createView();
    }

    public TrayViewWithOneItem(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
                        ...
                        if (Xdiff < 10 && Ydiff < 10 && !isDragStarted) {
                            if (mExpandedView == null) {
                                ...
                                if (mWhereAmI == 0 && mThresholdWhichkQuadrant == 0) {
                                    ...
                                    LayoutInflater.from(mContext).inflate(R.layout.tray_content_camera_view, mRightContainerView);
                                   ...
                                   for(int x = views.size() - 1; x >= 0; x--) {
                                    ...
                                    LayoutInflater.from(mContext).inflate(R.layout.tray_content_camera_view, mLeftContainerView);
