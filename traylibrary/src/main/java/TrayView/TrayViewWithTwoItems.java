...
public class TrayViewWithTwoItems extends View {

    public static final String TAG = TrayViewWithTwoItems.class.getSimpleName();
    ...
    public TrayViewWithTwoItems(Context context, int trayItemsNameArray, int trayItemIconArray) {
        super(context);
    ...
    public TrayViewWithTwoItems(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
        createView();
    }

    public TrayViewWithTwoItems(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
                        ...
                        if (Xdiff < 10 && Ydiff < 10 && !isDragStarted) {
                            if (mExpandedView == null) {
                                ...
                                if (mWhereAmI == 0 && mThresholdWhichkQuadrant == 0) {
                                    ...
                                    LayoutInflater.from(mContext).inflate(R.layout.tray_content_room_view, mRightContainerView);
                                    ...
                                    mEditImage.setImageResource(mTrayItemIconArr.getResourceId(0, 0));
                                    mEditLabel = (CustomTextView)mFloatingView.findViewById(R.id.edit_text);
                                    mEditLabel.setText(trayItemNames[0]);
                                    ...
                                    if(isFloorSelectImage)
                                    {
                                        ...
                                        mFloorLabel.setText(trayItemNames[1]);
                                   ...
                                   for(int x = views.size() - 1; x >= 0; x--) {
                                    ...
                                    LayoutInflater.from(mContext).inflate(R.layout.tray_content_room_view, mLeftContainerView);
